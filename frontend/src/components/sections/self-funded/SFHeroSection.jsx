      ...
      <div className="container-fluid grid gap-10 py-20 md:grid-cols-[1.15fr,1fr] md:items-end md:py-28">
        <Reveal>
          ...
          <p className="lead mt-6 max-w-2xl text-mentor-muted">
            Mentor Third-Party Administrator (TPA) turns self-funded healthcare into a structured,
            digital, and controllable system, helping companies reduce cost,
            improve visibility, and create a better employee experience.
          </p>
          <a
            href="/request-proposal"
            data-testid="sf-cta-hero"
            className="btn-shimmer mt-8 inline-flex items-center rounded-full bg-mentor-black px-8 py-4 text-sm font-semibold text-white transition hover:bg-mentor-blue"
          >
        ...
        <Reveal variant="right" delay={120}>
          <MediaImage
            ...
            alt="Corporate HR and finance meeting"
            ratio="4/3"
            frame
            overlay="soft"
          />
