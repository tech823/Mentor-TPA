...
const AILayerSection = () => {
  return (
    <section className="py-20 md:py-28" data-testid="home-ai" role="region" aria-label="Digital and AI Layer">
      <div className="container-edge grid gap-12 md:grid-cols-2 md:items-center">
        <Reveal>
          ...
          <p className="lead mt-5">
            Mentor Third-Party Administrator (TPA) is not a traditional TPA wrapped in nice branding. It
            is being built as a digital healthcare administration layer with
        ...
        <ul className="grid grid-cols-2 gap-2" aria-label="Key features of our digital and AI layer">
          {features.map((x, i) => (
            <Reveal key={i} delay={i * 40} as="li">
              <div className="flex items-start gap-2 rounded-xl border border-mentor-line p-4 text-sm font-semibold transition hover:border-mentor-blue hover:bg-mentor-blue/5 h-full">
