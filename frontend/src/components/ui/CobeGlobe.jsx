...
export function Globe({
  ...
  arcs = [],
  className = "",
  markerColor = [0, 0.28, 1], // Mentor Blue normalized
  baseColor = [1, 1, 1],
  arcColor = [0, 0.28, 1],
  glowColor = [0.92, 0.94, 1], // Subtle blue-tinted glow
  dark = 0,
  mapBrightness = 10,
  markerSize = 0.025,
        ...
        >
          ...
          <span
            style={{
              ...
              borderTopColor: "var(--mentor-black)",
            }}
          />
        </div>
      ))}
