        ...
        <div className="container-fluid grid gap-10 py-20 md:grid-cols-[1.15fr,1fr] md:items-end md:py-28">
          <Reveal>
            ...
            <p className="lead mt-6 max-w-2xl">
              Partner with Mentor Third-Party Administrator (TPA) to become part of a growing healthcare
          ...
          {[
            ...
            <Reveal key={i} delay={i * 100}>
              <div className="card-hard tilt-card p-7 h-full">
                <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-mentor-black text-white">
                  <col.icon className="h-5 w-5" />
                </div>
                <div className="mt-5 text-xl font-extrabold tracking-tight">
                  {col.t}
                </div>
