...
export default function BookDemo() {
  ...
  if (submitted)
    return (
      <main
        className="min-h-[90vh] flex items-center justify-center py-24 px-6 bg-mentor-surface/30"
        role="main"
      >
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="lead mt-6 text-mentor-muted">
              Thank you for your interest. A product specialist will contact you
              within{" "}
              <span className="text-mentor-blue font-bold">24 hours</span> to
              schedule your personalized walkthrough of the Mentor TPA
              ecosystem.
            </p>
          </motion.div>
          ...
          >
            <Link
              to="/"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-mentor-black px-10 py-4 text-sm font-bold text-white transition hover:bg-mentor-blue hover:shadow-lg hover:shadow-mentor-blue/20"
            >
              Back to Home
            </Link>
            <Link
              to="/technology"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full border border-mentor-line px-10 py-4 text-sm font-bold text-mentor-black transition hover:bg-mentor-surface"
            >
              View Technology
            </Link>
          </motion.div>
  ...
  return (
    <section
      className="relative py-20 md:py-32 overflow-hidden bg-mentor-surface/10"
      data-testid="bd-page"
    >
      ...
      <div className="container-edge relative z-10 grid gap-16 lg:grid-cols-[1fr,1.3fr]">
        <div>
          <Reveal>
            <Eyebrow icon={<Play className="h-3 w-3 fill-current" />}>
              Interactive Showcase
            </Eyebrow>
            <h1 className="display-2 mt-6 tracking-tight">
              Experience <span className="text-mentor-blue">next-gen</span> TPA.
            </h1>
            <p className="lead mt-6 text-mentor-muted">
              See how Mentor TPA orchestrates complex claims workflows, provider
              networks, and member experiences through a single, unified
              interface.
            </p>
          </Reveal>
          ...
          <Reveal
            delay={200}
            className="mt-10 group overflow-hidden rounded-3xl border border-mentor-line shadow-xl transition-all duration-500 hover:shadow-mentor-blue/10 relative"
          >
