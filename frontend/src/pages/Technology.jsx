    ...
    <>
      ...
      <section className="py-20 md:py-28">
        <div className="container-edge grid gap-10 md:grid-cols-2">
          <Reveal>
            <Eyebrow>Digital capabilities</Eyebrow>
            <h2 className="display-2 mt-5">
              Digital capabilities that reduce friction.
            </h2>
          ...
          <Reveal delay={120}>
            <Eyebrow>Claims intelligence</Eyebrow>
            <h2 className="display-2 mt-5">AI-enabled claims control.</h2>
            <p className="lead mt-5">
              Mentor TPA is designed to strengthen healthcare claims control
              through automated claim validation, OCR, duplicate detection,
              price comparison, anomaly flags, and data-driven claim workflows.
            </p>
            <ul className="mt-6 space-y-2">
              {bullets([
                "duplicate claim matching",
                "document modification checks",
          ...
          <Reveal variant="right" delay={120}>
            ...
            <ul className="mt-8 grid gap-3 sm:grid-cols-2">
              {[
                ...
                "multi-stakeholder integration capability",
                "reliability and security focus",
              ].map((x) => (
                <li
                  key={x}
                  className="rounded-xl border border-mentor-line bg-white p-5 text-sm font-semibold transition hover:border-mentor-blue hover:-translate-y-0.5"
                >
                  {x}
                </li>
              ))}
      ...
      <section className="relative overflow-hidden border-y border-mentor-line bg-mentor-black py-20 text-white md:py-28 grid-dark">
        <div
          ...
          style={{
            background:
              "radial-gradient(800px 400px at 90% 30%, rgba(0,72,255,0.25), transparent 60%)",
          }}
        />
      ...
      <CTABand
        eyebrow="Final CTA"
        headline="See Mentor TPA technology in action."
        subline="Book a demo or talk to our team."
        testId="tech-cta"
      />
    </>
  );
