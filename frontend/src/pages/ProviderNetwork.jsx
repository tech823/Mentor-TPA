...
const categories = [
  ...
  { i: UserRound, t: "specialists and doctors" },
  { i: FlaskConical, t: "laboratories and diagnostics" },
  { i: Pill, t: "pharmacies" },
  { i: Activity, t: "outpatient services" },
  { i: BedDouble, t: "hospitalization support" },
];
    ...
    <>
      <section className="relative overflow-hidden border-b border-mentor-line mesh-hero">
        ...
        <div className="container-fluid grid gap-10 py-20 md:grid-cols-[1.1fr,1fr] md:items-end md:py-28">
          <Reveal>
            ...
            >
              Request Network Information <ArrowUpRight className="h-4 w-4" />
            </Link>
          </Reveal>
      ...
      <section className="py-20 md:py-28">
        <div className="container-edge">
          <Reveal>
            <Eyebrow>Network overview</Eyebrow>
            <h2 className="display-2 mt-5 max-w-3xl">
              Structured access across major care categories.
            </h2>
          </Reveal>
        ...
        <div className="container-edge grid gap-10 md:grid-cols-2 md:items-center">
          <Reveal>
            ...
            <p className="lead mt-5">
              A strong network is not just about having names on a list. It is
              about enabling structured access, pricing consistency, better
              coordination, and smoother care journeys across locations.
            </p>
          </Reveal>
          <Reveal variant="right" delay={120}>
            <MediaImage
      ...
      <section className="border-y border-mentor-line bg-mentor-surface py-20 md:py-28">
        <div className="container-edge grid gap-10 md:grid-cols-2 md:items-center">
          ...
          <Reveal variant="right" delay={120}>
            ...
            <p className="lead mt-5">
              Mentor TPA supports a broad healthcare footprint across major
              cities and network locations, helping organizations provide more
              consistent access to employees and members wherever they are.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden border-t border-mentor-line bg-mentor-black py-20 text-white md:py-28 grid-dark">
        <div
          ...
          style={{
            background:
              "radial-gradient(700px 400px at 10% 50%, rgba(0,72,255,0.25), transparent 60%)",
          }}
        />
        <div className="container-edge relative">
          <div className="flex flex-col items-start gap-6 md:flex-row md:items-end md:justify-between">
            <Reveal>
              <Eyebrow>
                <span className="text-mentor-blue">Hospital Panel</span>
              </Eyebrow>
              <h2 className="display-2 mt-5 max-w-3xl text-white">
                Browse the Mentor TPA hospital panel.
              </h2>
            </Reveal>
            <Link
              to="/hospital-panel"
              data-testid="pn-cta-panel"
              className="btn-shimmer inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-semibold text-mentor-black transition hover:bg-mentor-blue hover:text-white"
            >
              View Hospital Panel List <ArrowUpRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
